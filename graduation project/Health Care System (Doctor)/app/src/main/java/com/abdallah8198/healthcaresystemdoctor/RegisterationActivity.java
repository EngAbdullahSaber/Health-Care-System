...
public class RegisterationActivity extends AppCompatActivity {
    // view
    EditText EmailEt, passeordEt,passeord2Et ,nameEt,phoneEt ,ageEt ,LiceEt;
    Button registerBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LiceEt =  findViewById(R.id.LinceEt);
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (LiceEt.length()<6) {
                    //set error and focus on Licence Number EditText
                    LiceEt.setError("Please Enter Valid Licence Number ");
                    LiceEt.setFocusable(true);
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            String Licence = LiceEt.getText().toString();
                            //using hashmap
                            ...
                            hashMap.put("age" , age);
                            hashMap.put("Licene Number" , Licence);
