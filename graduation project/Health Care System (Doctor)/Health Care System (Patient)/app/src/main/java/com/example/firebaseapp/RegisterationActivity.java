...
public class RegisterationActivity extends AppCompatActivity {
    // view
    EditText EmailEt, passeordEt , NamelEt ,phoneEd  , passeord2Et , addressTi  ,AgeEt  ;
    Button registerBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NamelEt = (EditText)findViewById(R.id.NamelEt);
        phoneEd = (EditText)findViewById(R.id.phoneEd);
        passeord2Et = (EditText)findViewById(R.id.passeord2Et);
        addressTi = (EditText)findViewById(R.id.addressTi);
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
                    ...
                    passeordEt.setError("Password invalidat least 6 characters");
